...
- July 18, 2025. Fixed passenger pickup "Confirm Pickup" functionality by correcting API call structure and data validation. Updated apiRequest usage to proper method signature, added required tripId field to pickup data, and fixed response handling. Also disabled automatic trip completion logic in WebSocket handler to prevent trips from being auto-ended after 30 seconds, giving users better control over trip management.
